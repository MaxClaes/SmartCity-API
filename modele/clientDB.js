...
module.exports.createClient = async (client, nom, prenom, adresse, password, email) => {
    return await client.query(`
        INSERT INTO client(nom, prenom, adresse, password, email) 
        VALUES ($1, $2, $3, $4, $5)`, [nom, prenom, adresse, await getHash(password), email]
    );
};
