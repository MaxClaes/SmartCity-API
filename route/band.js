...
router.delete('/mybands/:bandId/out', JWTMiddleWare.identification, validatorBand.bandExists, validatorBand.authUserExistsInBand, validatorBand.hasAcceptedStatus, bandControleur.deleteMember);  //idBand, idMember | Vérifier si user dans idBand, idMember dans idBand, user a role suffisant |Si plus de membre => band supprimé
