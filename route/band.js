...
router.post('/mybands/:bandId/members/:userId', JWTMiddleWare.identification, ValidatorMiddleWare.bandExists, ValidatorMiddleWare.authUserExistsInBand, ValidatorMiddleWare.userExists, BandControleur.addMember);  //idBand, idNewMember | Vérifier si user dans idBand | N'importe qui du groupe peut ajouter un membre
...
router.patch('/mybands/:bandId/members/:userId/role', JWTMiddleWare.identification, ValidatorMiddleWare.bandExists, ValidatorMiddleWare.userExistsInBand, ValidatorMiddleWare.authUserIsAdministratorInBand, ValidatorMiddleWare.roleIsValid, ValidatorMiddleWare.canChangeRoleInBand, BandControleur.changeRole);

router.get('/invitations', JWTMiddleWare.identification, BandControleur.getAllInvitations);
router.patch('/invitations/:bandId/accept', JWTMiddleWare.identification, ValidatorMiddleWare.bandExists, ValidatorMiddleWare.authUserExistsInBand, BandControleur.acceptInvitation);
router.patch('/invitations/:bandId/refuse', JWTMiddleWare.identification, ValidatorMiddleWare.bandExists, ValidatorMiddleWare.authUserExistsInBand, BandControleur.refuseInvitation);
