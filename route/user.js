...
router.post('/login', validatorUser.authenticationValids, userController.login);
...
router.patch('/role', JWTMiddleWare.identification, authoMiddleware.canChangeRole, validatorUser.userExists, validatorUser.roleIsValid, userController.changeRole)
